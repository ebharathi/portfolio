        ...
        <nav className="py-4">
           <div className="flex mx-8">
                 ...
                 <div className="flex-1 flex mt-2">
                       <div className="flex-1 text-center px-3 cursor-pointer hover:text-[#909692] h-5 text-[18px]" style={{borderRight:"2px solid black"}}>
                          Projects
                       </div>
                       <div  className="flex-1 text-center px-3 cursor-pointer hover:text-[#909692] h-5 text-[18px]" style={{borderRight:"2px solid black"}}>
                          Resume
                       ...
                       <div  className="flex-1 text-center px-3 cursor-pointer hover:text-[#909692] h-5 text-[18px]">
                          Portfolio
                       </div>
                 </div>
           </div>
